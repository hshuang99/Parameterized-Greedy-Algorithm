...
\newcommand{\titleZH}{優化量子區塊加密之線性可逆電路的深度導向貪婪演算法} % 此括弧內填入論文中文標題Chinese title here
\newcommand{\titleEN}{An Optimal Depth-Oriented Greedy Algorithm for Linear Reversible Quantum Circuits of Block Ciphers} % 此括弧內填入論文英文標題
