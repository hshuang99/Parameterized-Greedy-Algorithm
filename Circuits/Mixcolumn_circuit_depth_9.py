...
Usage:
    ...
    python mixcolumn_circuit.py # outputs: Mixcolumn_circuit_depth_9.tex
    pdflatex mixcolumn_circuit.tex # outputs: Mixcolumn_circuit_depth_9.pdf 
"""

from projectq import MainEngine
from projectq.backends import ResourceCounter, _resource, CircuitDrawer
...
# ---------------------------------------------------------------------------
# MixColumn — depth-9, 109 CNOT gates
# ---------------------------------------------------------------------------
...
def main():
    ...
    output_file = f"Mixcolumn_circuit_depth_{format(circuit_backend.depth_of_dag)}.tex"
